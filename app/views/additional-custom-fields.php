...
<div class="form-wrapper">
    <div class="field-wrapper field-row">
        <div class="col-6">
            <div class="sa-input-group">
                <label for="promotion_subtitle" class="input-label"><?php _e( 'Sub Title', 'adjuster-forge' ); ?></label>
        ...
        <div class="col-6">
            <div class="sa-input-group">
                <label for="promotion_brand_name" class="input-label"><?php _e( 'Brand Name', 'adjuster-forge' ); ?></label>
                <div class="form-field">
    ...
    <div class="field-wrapper field-row">
        <div class="col-6">
            <div class="image-group">
                <div class="img-selector">
                    <label class="input-label" for="promotion_barnd_logo"><?php _e( 'Logo', 'adjuster-forge' ); ?></label>
                    <input type="hidden" id="promotion_barnd_logo" name="promotion_barnd_logo" value="<?php echo esc_attr( $logo ); ?>" class="widefat">
                    <button type="button" class="btn btn-img" id="promotion_barnd_logo_button"><?php _e( 'Barnd Logo', 'adjuster-forge' ); ?></button>
                </div>
        ...
        <div class="col-6">
            <div class="image-group">
                <div class="img-selector">
                    <label class="input-label" for="promotion_banner"><?php _e( 'Banner', 'adjuster-forge' ); ?></label>
                    <input type="hidden" id="promotion_banner" name="promotion_banner" value="<?php echo esc_attr( $banner ); ?>" class="widefat">
                    <button type="button" class="btn btn-img" id="promotion_banner_button"><?php _e( 'Promotion Banner', 'adjuster-forge' ); ?></button>
                </div>
    ...
    <div class="field-wrapper field-row">
        <div class="col-6">
            <label for="promotion_location" class="input-label"><?php _e( 'Location', 'adjuster-forge' ); ?></label>
            <div class="form-field">
        ...
        <div class="col-6">
            <label for="promotion_coupon" class="input-label"><?php _e( 'Coupon Code', 'adjuster-forge' ); ?></label>
            <div class="form-field">
    ...
    <div class="field-wrapper field-row">
        <div class="sa-input-group">
            <label for="promotion_brand_link" class="input-label"><?php _e( 'Brand Link', 'adjuster-forge' ); ?></label>
            <div class="form-field">
    ...
    <div class="field-wrapper field-row">
        <div class="sa-input-group">
            <label for="promotion_terms" class="input-label"><?php _e( 'Terms and Conditions', 'adjuster-forge' ); ?></label>
            <div class="form-field">
