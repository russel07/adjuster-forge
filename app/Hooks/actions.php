<?php
    ...
    add_action( 'init', [ ActionHooksHandler::class, 'driver_forge_rewrite_rules'] );
    add_action( 'template_redirect', [ ActionHooksHandler::class, 'driver_forge_file_download_handler'] );
    ...
    add_action('diver_forge_after_driver_profile_approved', [ ActionHooksHandler::class, 'send_user_profile_approved_email'] );
    //Send email to user after profile rejected
    add_action('diver_forge_after_driver_profile_rejected', [ ActionHooksHandler::class, 'send_user_profile_rejected_email'] );

    //Hooks to daily task
    add_action('driver_forge_daily_tasks', [ CleanupHandler::class, 'maybe_expire_subscriptions']);
    ...
    add_action(
        'wp_ajax_driver_forge_renew_rest_nonce',
        function () {
            wp_send_json(
                array(
